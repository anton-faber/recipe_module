...
def insert_data(cursor, item_name, ingredient_name, quantity, unit):
    cursor.execute('''
        INSERT INTO items (item_name, ingredient_name, quantity, unit)
        VALUES (?, ?, ?, ?)
    ''', (item_name, ingredient_name, quantity, unit))
        ...
        if choice == '1':
            with open('ing.csv', 'r') as csv_file:
                ...
                for row in csv_reader:
                    ...
                    insert_data(db_cursor, item_name, ingredient_name, quantity, unit)
